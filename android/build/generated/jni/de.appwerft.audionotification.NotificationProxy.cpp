...
, javaClass, nameSymbol);
	...
	titanium::SetProtoMethod(isolate, t, "create", NotificationProxy::create);
...
void NotificationProxy::show(const FunctionCallbackInfo<Value>& args)
{
	...
	if (!methodID) {
		methodID = env->GetMethodID(NotificationProxy::javaClass, "show", "(Lorg/appcelerator/kroll/KrollDict;)V");
		if (!methodID) {
...
void NotificationProxy::create(const FunctionCallbackInfo<Value>& args)
{
	LOGD(TAG, "create()");
	Isolate* isolate = args.GetIsolate();
	HandleScope scope(isolate);
	...
	static jmethodID methodID = NULL;
	if (!methodID) {
		methodID = env->GetMethodID(NotificationProxy::javaClass, "create", "(Lorg/appcelerator/kroll/KrollDict;)V");
		if (!methodID) {
...
void NotificationProxy::update(const FunctionCallbackInfo<Value>& args)
{
	...
	static jmethodID methodID = NULL;
	if (!methodID) {
		methodID = env->GetMethodID(NotificationProxy::javaClass, "update", "(Lorg/appcelerator/kroll/KrollDict;)V");
		if (!methodID) {
