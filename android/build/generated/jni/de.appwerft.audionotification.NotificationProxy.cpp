...
Persistent<FunctionTemplate> NotificationProxy::proxyTemplate;
jclass NotificationProxy::javaClass = NULL;

NotificationProxy::NotificationProxy() : titanium::Proxy()
{
}

void NotificationProxy::bindProxy(Local<Object> exports, Local<Context> context)
{
...
Local<FunctionTemplate> NotificationProxy::getProxyTemplate(v8::Isolate* isolate)
{
	...
	LOGD(TAG, "NotificationProxy::getProxyTemplate()");

	javaClass = titanium::JNIUtil::findClass("de/appwerft/audionotification/NotificationProxy");
	...
	titanium::SetProtoMethod(isolate, t, "stop", NotificationProxy::stop);
	titanium::SetProtoMethod(isolate, t, "release", NotificationProxy::release);
	titanium::SetProtoMethod(isolate, t, "start", NotificationProxy::start);
...
void NotificationProxy::hide(const FunctionCallbackInfo<Value>& args)
{
	...
	if (!methodID) {
		methodID = env->GetMethodID(NotificationProxy::javaClass, "hide", "()V");
		if (!methodID) {
...
void NotificationProxy::stop(const FunctionCallbackInfo<Value>& args)
{
	LOGD(TAG, "stop()");
	Isolate* isolate = args.GetIsolate();
	Local<Context> context = isolate->GetCurrentContext();
	...
	static jmethodID methodID = NULL;
	if (!methodID) {
		methodID = env->GetMethodID(NotificationProxy::javaClass, "stop", "()V");
		if (!methodID) {
...
void NotificationProxy::release(const FunctionCallbackInfo<Value>& args)
{
	LOGD(TAG, "release()");
	Isolate* isolate = args.GetIsolate();
	Local<Context> context = isolate->GetCurrentContext();
	...
	static jmethodID methodID = NULL;
	if (!methodID) {
		methodID = env->GetMethodID(NotificationProxy::javaClass, "release", "()V");
		if (!methodID) {
...
void NotificationProxy::start(const FunctionCallbackInfo<Value>& args)
{
	LOGD(TAG, "start()");
	Isolate* isolate = args.GetIsolate();
	Local<Context> context = isolate->GetCurrentContext();
	...
	static jmethodID methodID = NULL;
	if (!methodID) {
		methodID = env->GetMethodID(NotificationProxy::javaClass, "start", "()V");
		if (!methodID) {
...
void NotificationProxy::setTitle(const FunctionCallbackInfo<Value>& args)
{
	LOGD(TAG, "setTitle()");
	Isolate* isolate = args.GetIsolate();
	Local<Context> context = isolate->GetCurrentContext();
	...
	static jmethodID methodID = NULL;
	if (!methodID) {
		methodID = env->GetMethodID(NotificationProxy::javaClass, "setTitle", "(Ljava/lang/String;)V");
		if (!methodID) {
			const char *error = "Couldn't find proxy method 'setTitle' with signature '(Ljava/lang/String;)V'";
			LOGE(TAG, error);
				titanium::JSException::Error(isolate, error);
				return;
		}
	...
	if (args.Length() < 1) {
		...
		sprintf(errorStringBuffer, "setTitle: Invalid number of arguments. Expected 1 but got %d", args.Length());
...
void NotificationProxy::setSubtitle(const FunctionCallbackInfo<Value>& args)
{
	...
	static jmethodID methodID = NULL;
	if (!methodID) {
		methodID = env->GetMethodID(NotificationProxy::javaClass, "setSubtitle", "(Ljava/lang/String;)V");
		if (!methodID) {
			const char *error = "Couldn't find proxy method 'setSubtitle' with signature '(Ljava/lang/String;)V'";
			LOGE(TAG, error);
				titanium::JSException::Error(isolate, error);
				return;
		}
	...
	if (args.Length() < 1) {
		char errorStringBuffer[100];
		sprintf(errorStringBuffer, "setSubtitle: Invalid number of arguments. Expected 1 but got %d", args.Length());
		titanium::JSException::Error(isolate, errorStringBuffer);
		return;
	}
